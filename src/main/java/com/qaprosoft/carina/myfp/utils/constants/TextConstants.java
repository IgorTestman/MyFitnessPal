...
public interface TextConstants {
    ...
    String UPPER_CASE_LETTERS = "ASXERHTYIB";
    String DIGITS = "1234567890";
    String SIGNS = "><*&^%$#@!";
    String VALUE_MIX = "@#0879RtYq";
    String INVALID_EMAIL = "wertyujbvrt.bvcert.com";
    String TOO_SHORT_PASSWORD = "Wc3!@";
    double CURRENT_WEIGHT_IN_LB = 998.0;
    int MAX_CURRENT_WEIGHT_IN_LB = 999;
    String YES = "Yes";
    String SET = "Set";
    ...
    String CHOSEN_CURRENT_WEIGHT_IN_KG = "324.7 kg";
